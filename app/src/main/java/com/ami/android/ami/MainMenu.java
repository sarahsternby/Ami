...
import com.ami.android.ami.Model.Category;
import com.ami.android.ami.ViewHolder.MenuViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(login);
                finish(); // this prevents users from using the Android back button to return to main menu
        ...
        // Load menu
        recyclerMenu = (RecyclerView)findViewById(R.id.mainmenu);
